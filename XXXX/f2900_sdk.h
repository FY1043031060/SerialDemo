...
typedef enum
{
    BAUDRATE_4800, BAUDRATE_7200,
    BAUDRATE_9600, BAUDRATE_14400,
    BAUDRATE_19200, BAUDRATE_28800,
    BAUDRATE_38400, BAUDRATE_57600,
    BAUDRATE_115200, BAUDRATE_230400
} BAUDRATE_NORMAL_T;
typedef enum
{
    SERIAL_NO_PARITY = 0, SERIAL_EVEN_PARITY = 1, SERIAL_ODD_PARITY = 2
} SERIAL_PARITY_T;
...
typedef enum {RS422_ASYN1_PORT, RS422_ASYN2_PORT, RS422_ASYN3_PORT, RS422_ASYN4_PORT,
              RS422_ASYN5_PORT, RS422_ASYN6_PORT, RS422_SYN1_PORT, RS422_ASYN1_EXTRA_PORT, RS422_ASYN2_EXTRA_PORT, MAX_SERIAL_PORT_NUM
             } RS422_SERIAL_TYPE_T;
...
//RS422 oper
NENGTONG_API int __stdcall OpenRS422Port(RS422_SERIAL_TYPE_T ePortType, BAUDRATE_NORMAL_T eBaudRate, SERIAL_PARITY_T eParity);
